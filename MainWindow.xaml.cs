...
namespace WeatherForecast
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private async void TownBox_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            using HttpClient clientGeo = new();
            clientGeo.Timeout = TimeSpan.FromSeconds(10); // if HTTP is overloaded program will wait 10 sec before throwing exception
            ...
            try
            {
                ...
                Towns = JsonSerializer.Deserialize<List<Town>>(jsonStringGeo); //making a list of deseralized towns from json 
                ChooseCombo.ItemsSource = new ObservableCollection<Town>(Towns); // making ObservableCollection for ChooseCombo


            }
            catch (Exception ex) // catching Exception when program cant get Data
            {
        ...
        } // function to gathering data to ChooseCombo 
        ...
        public void ResetTownBox()
        {
            TownBox.Text = "Enter City Name";
            TownBox.Foreground = Brushes.Black;
        } // function to reset TownBox when user return to MainWindow
        ...
        private async void FindButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string meteoUrl = $"https://api.open-meteo.com/v1/forecast?latitude={selectedTown.Latitude}" + $"&longitude={selectedTown.Longitude}" + $"&hourly=temperature_2m,precipitation,relative_humidity_2m,windspeed_10m,precipitation_probability,pressure_msl&forecast_days=7&timezone=Europe/Berlin";

            using HttpClient clientMeteo = new();
        ...
        } // function to find WeatherData having Latitude and Longitude of choosen town
